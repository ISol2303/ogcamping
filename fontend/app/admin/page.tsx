    ...
    <div className="flex min-h-screen bg-gray-50">
      <div className="flex-1">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <Tabs defaultValue="overview" className="space-y-6">
            <div className="overflow-x-auto">
              <TabsList className="flex gap-2 px-2 py-1 min-w-max">
                <TabsTrigger value="overview" className="px-4 py-2 rounded-lg text-sm font-medium transition-colors 
       ...
       whitespace-nowrap"
                ...
                <TabsTrigger value="staff" className="px-4 py-2 rounded-lg text-sm font-medium transition-colors 
       hover:bg-green-100 hover:text-green-700 
       data-[state=active]:bg-green-600 data-[state=active]:text-white
       whitespace-nowrap">
                  Nhân viên
       ...
       whitespace-nowrap"
                ...
                <TabsTrigger value="equipment" className="px-4 py-2 rounded-lg text-sm font-medium transition-colors 
       hover:bg-green-100 hover:text-green-700 
       data-[state=active]:bg-green-600 data-[state=active]:text-white
       whitespace-nowrap">
                  Thiết bị
                ...
                <TabsTrigger value="customers" className="px-4 py-2 rounded-lg text-sm font-medium transition-colors 
       hover:bg-green-100 hover:text-green-700 
       data-[state=active]:bg-green-600 data-[state=active]:text-white
       whitespace-nowrap">
                  Khách hàng
                ...
                <TabsTrigger value="locations" className="px-4 py-2 rounded-lg text-sm font-medium transition-colors 
       hover:bg-green-100 hover:text-green-700 
       data-[state=active]:bg-green-600 data-[state=active]:text-white
       whitespace-nowrap">
                  Địa điểm
                ...
                <TabsTrigger value="inventory" className="px-4 py-2 rounded-lg text-sm font-medium transition-colors 
       hover:bg-green-100 hover:text-green-700 
       data-[state=active]:bg-green-600 data-[state=active]:text-white
       whitespace-nowrap">
                  Kho
                ...
                <TabsTrigger value="pricing-promotions" className="px-4 py-2 rounded-lg text-sm font-medium transition-colors 
       hover:bg-green-100 hover:text-green-700 
       data-[state=active]:bg-green-600 data-[state=active]:text-white
       whitespace-nowrap">
                  Giá & Khuyến mãi
